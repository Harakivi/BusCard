...
set(CMAKE_ASM_FLAGS "${MCU_FLAGS} -Wall -pedantic" CACHE INTERNAL "asm compiler flags")
set(CMAKE_C_FLAGS "${MCU_FLAGS} -Wall -pedantic"  CACHE INTERNAL "c compiler flags")
set(CMAKE_CXX_FLAGS "${MCU_FLAGS} -std=c++17 -Wall -pedantic" CACHE INTERNAL "cxx compiler flags")

set(CMAKE_ASM_FLAGS_DEBUG "${CMAKE_ASM_FLAGS} -g3 -Og -DDEBUG")
set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS} -g3 -Og -DDEBUG")
set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS} -g3 -Og -DDEBUG")
